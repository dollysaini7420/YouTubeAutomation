...
// public static void PrintMessage(WebElement element){
//     try {
//         String Message = element.getText();
//         System.out.println(Message);
//     } catch (Exception e) {
//         System.out.println("An error occurred while trying to get the message: " + e.getMessage());
//         e.printStackTrace();
//     }
// }
...
public class Wrappers {
    ...
    public static boolean waitForUrlToContain(String urlPart, int timeoutInSeconds,WebDriver driver) {
        try {
  ...
  public static void genreOfLastMovie(ChromeDriver driver) {
    ...
    public static void clickOnTab(ChromeDriver driver, String movieName) throws InterruptedException {
      try {
        Thread.sleep(1000);
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement tabElement= driver.findElement(By.xpath("//a[@title='Movies']"));
